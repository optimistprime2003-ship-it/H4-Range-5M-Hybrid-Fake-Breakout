...
# if they don't already exist, sends a Telegram alert for each
# genuinely new signal (if enabled), and saves everything.
# =========================================================
...
# dashboard. This is what makes scanning and alerting actually
# "live" instead of only happening when the page is open.
# =========================================================
